...
<body class="bg-gray-200 pt-24">
  ...
  <div class="container mx-auto px-6">
    <h2 class="text-3xl font-bold text-center">Welcome to the Manager Home Page</h2>
    <p class="mt-4 text-lg text-center">This page is exclusively for managers to review and approve supply requests.</p>
  </div>
</body>
</html>
